...
var baseChannelJoin = function baseChannelJoin(dataStore, message) {
  ...
  if (baseChannel.members.indexOf(message.user) === -1) {
    ...
    console.log('*** *** *** baseChannelJoin', { activeUserId: message.user, channel: message.channel, members: baseChannel.members });
  }
...
var baseChannelLeave = function baseChannelLeave(dataStore, message) {
  ...
  if (memberIndex !== -1) {
    ...
    console.log('*** *** *** baseChannelLeave', { activeUserId: message.user, channel: message.channel, index: memberIndex, members: baseChannel.members });
  }
